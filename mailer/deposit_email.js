...
font-family: 'Roboto', sans-serif;
  ...
  <div class="maincontainer">
    ...
    <p class="sm-p">
      Dear ${userInfo.first_name} ${userInfo.last_name}, we have recieved your deposit 
      on <b>${datetime}</b>.
    ...
    <p class="sm-p">
    NB:all your deposit will be converted to (united state dollars(USD)) which is the default currency used @fleekinvest.
